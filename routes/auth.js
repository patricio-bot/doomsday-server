...
//HELPER FUNCTIONS vienen de helpers/middlewares
...
router.post(
    ...
    async (req, res, next) => {
        ...
        try {
            ...
            const usernameExists = await User.findOne({ lastName }, "lastName");
            ...
            if (usernameExists) return next(createError(400));
                ...
                const newUser = await User.create({ firstName, lastName, gender, email, password: hashPass });
